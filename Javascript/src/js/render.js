...
function getValue(){
    ...
    time = element.value * 1000;
}

function change(){
    if (document.getElementById("choice").value == "one"){
...
function count(){
    let celcius = document.getElementById('counts').value;
    document.getElementById('counts').value = celcius * 1 + 1
}
